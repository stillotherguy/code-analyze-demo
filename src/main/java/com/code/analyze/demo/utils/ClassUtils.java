...
package com.code.analyze.demo.utils;
...
public abstract class ClassUtils {
    ...
    public static String getShortName(String className) {
        Preconditions.checkNotNull(className, "Class name must not be empty");
    ...
    public static Method getMethod(Class<?> clazz, String methodName, Class<?>... paramTypes) {
        Preconditions.checkNotNull(clazz, "Class must not be null");
        Preconditions.checkNotNull(clazz, "Method name must not be null");
        if (paramTypes != null) {
            try {
